...
const MOCK_RECENT = [
  ...
  {
    _id: "3",
    trackingNo: "SMG-20240003",
    customer: "Amit Kumar",
    destination: "Delhi → Kolkata",
    status: "pending",
    date: "9 Jun 2025",
    weight: "5.1 kg",
  },
  {
    _id: "4",
    trackingNo: "SMG-20240004",
    customer: "Sunita Rao",
    destination: "Hyderabad → Pune",
    status: "processing",
    date: "9 Jun 2025",
    weight: "1.2 kg",
  },
  {
    _id: "5",
    trackingNo: "SMG-20240005",
    customer: "Deepak Singh",
    destination: "Chennai → Mumbai",
  ...
  {
    _id: "6",
    trackingNo: "SMG-20240006",
    customer: "Neha Gupta",
    destination: "Jaipur → Ahmedabad",
    status: "cancelled",
    date: "8 Jun 2025",
    weight: "0.5 kg",
  },
    ...
    const load = async () => {
      try {
        ...
        if (recentRes.data?.shipments) {
          ...
          const failedDeliveries = allShipments.filter(
            (s) => s.status === "Failed",
          ).length;
          ...
          const shipments = recentRes.data.shipments.map((s) => ({
            _id: s._id,
  ...
  return (
    <DashboardLayout pageTitle="Admin Dashboard">
      ...
      <div className="flex items-center gap-2 bg-amber-50 border border-amber-200 rounded px-4 py-2 mb-4 text-xs text-amber-700">
        ...
        <span>
          <strong>12 delayed shipments</strong> require attention — Route
          MUM-DEL experiencing congestion.
        </span>
        <a
          href="#"
      ...
      <div className="grid lg:grid-cols-3 gap-4 mb-5">
        ...
        <div className="card lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[10px] text-slate-400 bg-slate-50 border border-slate-100 px-2 py-1 rounded font-semibold uppercase tracking-wider">
              Jan – Jun 2025
            </span>
          </div>
