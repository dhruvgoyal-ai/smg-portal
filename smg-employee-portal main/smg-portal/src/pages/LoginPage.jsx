...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const email =
      form.role === "customer" || form.userId.includes("@")
        ? form.userId
        : `${form.userId}@smg.com`;
    ...
    <div className="min-h-screen flex bg-[#f0f4f8]">
      ...
      <div className="w-full lg:w-[480px] xl:w-[520px] flex flex-col bg-white shadow-2xl z-10">
        ...
        <div className="bg-[#0d2137] px-8 py-5 flex items-center gap-4">
          <div className="flex items-center justify-center w-12 h-12 rounded bg-white">
            <span className="text-[#0d2137] font-black text-xl tracking-tighter">
              SMG
            </span>
          </div>
          <div>
            ...
            <p className="text-[#7fa8c9] text-xs mt-0.5 font-medium">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 py-8 overflow-y-auto">
          ...
          {/* Role selection */}
          <div className="mb-5">
            <label className="block text-xs font-bold text-[#0d2137] mb-2 uppercase tracking-wider">
              Login As
            </label>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex justify-end mt-1">
                <a href="#" className="text-xs text-[#1a6ab1] hover:underline">
                  Forgot password?
                </a>
              </div>
            </div>
            ...
            >
              ...
              {loading ? "Authenticating…" : "Proceed to Authentication"}
            </button>
            ...
            <p className="text-center text-sm text-slate-500">
              ...
              <Link
                to="/register"
                className="text-[#1a6ab1] font-semibold hover:underline"
              >
                Create Account
              </Link>
            </p>
          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            <p className="text-[10px] text-slate-400 uppercase tracking-widest text-center font-semibold mb-2">
              Demo Quick Login
            </p>
            <div className="grid grid-cols-3 gap-2">
        ...
        <div className="px-8 py-4 bg-slate-50 border-t border-slate-200">
          <p className="text-[10px] text-slate-400 text-center">
            © 2025 SMG Ltd. · Confidential Internal System · Unauthorised access
      ...
      <div className="hidden lg:flex flex-1 flex-col bg-[#0d2137] relative overflow-hidden">
        ...
        <div className="relative z-10 p-10 flex items-center justify-between">
          <div>
            <p className="text-[#7fa8c9] text-xs uppercase tracking-widest font-semibold">
              Welcome to
            </p>
            <h2 className="text-white font-black text-3xl mt-1 tracking-wide">
              SMG Ltd.
            </h2>
            <p className="text-[#7fa8c9] text-sm mt-1">
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-10">
          ...
          >
            ...
            />
            <polygon
              points="248,184 260,174 272,184"
              fill="white"
              opacity="0.9"
            />
            ...
            <rect
              ...
              opacity="0.8"
            />
            <text x="90" y="363" fill="#7fa8c9" fontSize="8.5" fontWeight="700">
              500+ PARTNERS
            </text>
            <text
              x="230"
