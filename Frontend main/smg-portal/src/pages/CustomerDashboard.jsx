    ...
    <DashboardLayout pageTitle="Customer Dashboard">
      ...
      <div className="bg-[#0d2137] rounded border border-[#1a3a5c] p-5 mb-5">
        <div className="flex items-start justify-between mb-3">
          <div>
            ...
            <p className="text-[#7fa8c9] text-xs mt-1">
              Track your consignments or check delivery status below.
            </p>
          </div>
          <div className="hidden sm:block bg-white/8 border border-white/10 rounded px-3 py-2 text-center">
            <p className="text-[10px] text-[#7fa8c9] uppercase tracking-wider">
              Customer ID
            </p>
        ...
        <form onSubmit={handleTrack} className="flex gap-2 max-w-lg">
          ...
          <button
            type="submit"
            className="bg-[#1a6ab1] hover:bg-[#1558a0] text-white font-bold px-4 py-2.5 rounded text-xs transition-colors flex items-center gap-1.5"
          >
      ...
      <div className="grid sm:grid-cols-2 gap-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-white font-bold text-xs">
                SMG Customer Support
              </h4>
              <p className="text-[#7fa8c9] text-[10px] mt-0.5">
                Available Mon–Sat, 9 AM – 7 PM
              </p>
              <p className="text-[#1a6ab1] text-xs font-bold mt-1">
                1800-SMG-0001
              </p>
            </div>
          </div>
        ...
        <div className="card bg-amber-50 border-amber-100">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-[#0d2137] font-bold text-xs">
                Book a New Shipment
              </h4>
              <p className="text-slate-500 text-[10px] mt-0.5">
                Contact your account manager to initiate a pickup.
              </p>
              <button className="mt-1 text-xs text-[#1a6ab1] font-bold hover:underline">
                Request Pickup →
              </button>
            </div>
          </div>
